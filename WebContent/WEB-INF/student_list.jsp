	...
	<form method="get">
		<div class="row border mx-3 mb-3 py-3 align-items-center rounded" id="filter">
			...
			<select class="form-select" id="student-fl-select" name="fl">
				...
				<c:forEach var="year" items="${ent_year_set}">
					<%--現在のyearと選択とされていたf1が一致した場合selectedを追記  --%>
		...
		<div class="col-4">
			...
			<select class="form-select" id="student-f2-select" name="f2">
				<option value="0">----------</option>
				<c:forEach var="num" items="${class_num set }">
				<%--現在のnumと選択されていたf1が一致した場合seletを追記 --%>
		...
		<div class="col-2 text-center">
			<button class="btn btn-secondary" id="fileter-button">絞り込み</button>
		</div>
